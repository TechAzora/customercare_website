...
const CompnayServiceListing = () => {
  ...
  useEffect(() => {
    dispatch(CompanyGetAllProviders({ search, page, limit, serviceCategoryId }));
    dispatch(getAllCategories());
    dispatch(getAllSkills());
  }, [dispatch, search, page, limit, serviceCategoryId]);
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-6 p-6">
        ...
        <div className="w-full lg:w-3/4">
          ...
          {status === "failed" && <p className="text-red-500">Error fetching companies</p>}
            ...
            {providers.map((company) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600">Pincode: {company.pincode}</p>
